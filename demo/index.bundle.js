...
helpers = this.merge(helpers, Handlebars.helpers); data = data || {};
  var stack1, element1, self=this, helperMissing=helpers.helperMissing, appendChild=this.appendChild, functionType="function";
...
function program3(depth0,data) {
  ...
  var buffer = document.createDocumentFragment(), stack1, stack2, element1, element2, element3;
  appendChild(buffer, document.createTextNode("\n    "));
  stack1 = element1 = self.createElement(self.partial(self.program(4, program4, data), depth0), function (el) { element1 = el; });
  appendChild(element1, self.program(6, program6, data)(depth0));
  appendChild(buffer, stack1);
  appendChild(buffer, document.createTextNode("\n    "));
  stack1 = element2 = self.createElement(self.partial(self.program(8, program8, data), depth0), function (el) { element2 = el; });
  appendChild(element2, self.program(10, program10, data)(depth0));
  appendChild(buffer, stack1);
  appendChild(buffer, document.createTextNode("\n    "));
  stack1 = element3 = self.createElement(self.partial(self.program(12, program12, data), depth0), function (el) { element3 = el; });
  appendChild(element3, self.program(14, program14, data)(depth0));
  appendChild(buffer, stack1);
  appendChild(buffer, document.createTextNode("\n     "));
  stack1 = function () {
  stack2 = helpers['if'].call(depth0, self.get(depth0, "show", "depth0"), {hash:{},inverse:self.wrapProgram(self.noop),fn:self.wrapProgram(self.program(20, program20, data)),data:data,attribute:false,update:self.subscription.boundUpdate,unsubscribe:self.subscription.boundUnsubscription});
  return stack2;
  };
  appendChild(buffer, self.createDOM(stack1));
  appendChild(buffer, document.createTextNode("\n"));
  return buffer;
  }
...
function program6(depth0,data) {
  ...
  stack1 = function () {
  stack2 = (helper = helpers.upper || self.get(depth0, "upper", "depth0"),options={hash:{},data:data,attribute:false,update:self.subscription.boundUpdate,unsubscribe:self.subscription.boundUnsubscription},helper ? helper.call(depth0, self.get(depth0, "title", "depth0"), options) : helperMissing.call(depth0, "upper", self.get(depth0, "title", "depth0"), options));
  return stack2;
  };
  return self.createText(stack1);
  }
...
function program10(depth0,data) {
  ...
  appendChild(buffer, document.createTextNode("\n        "));
  stack1 = function () {
  if (helper = helpers.currentTime) { stack2 = helper.call(depth0, {hash:{},data:data,attribute:false,update:self.subscription.boundUpdate,unsubscribe:self.subscription.boundUnsubscription}); }
  else { helper = self.get(depth0, "currentTime", "depth0"); stack2 = typeof helper === functionType ? helper.call(depth0, {hash:{},data:data,attribute:false,update:self.subscription.boundUpdate,unsubscribe:self.subscription.boundUnsubscription}) : helper; }
  return stack2;
  };
  appendChild(buffer, self.createText(stack1));
  appendChild(buffer, document.createTextNode("\n    "));
  return buffer;
  }
...
function program14(depth0,data) {
  ...
  appendChild(buffer, document.createTextNode("\n        "));
  stack1 = function () {
  stack2 = helpers.each.call(depth0, self.get(depth0, "items", "depth0"), {hash:{},inverse:self.wrapProgram(self.noop),fn:self.wrapProgram(self.program(15, program15, data)),data:data,attribute:false,update:self.subscription.boundUpdate,unsubscribe:self.subscription.boundUnsubscription});
  return stack2;
  };
  appendChild(buffer, self.createDOM(stack1));
  appendChild(buffer, document.createTextNode("\n    "));
...
function program15(depth0,data) {
  ...
  appendChild(buffer, document.createTextNode("\n        "));
  stack1 = element1 = self.createElement(self.partial(self.program(16, program16, data), depth0), function (el) { element1 = el; });
  appendChild(element1, self.program(18, program18, data)(depth0));
  appendChild(buffer, stack1);
  appendChild(buffer, document.createTextNode("\n        "));
  return buffer;
  }
...
function program20(depth0,data) {
  ...
  var buffer = document.createDocumentFragment(), stack1, element1;
  appendChild(buffer, document.createTextNode("\n        "));
  stack1 = element1 = self.createElement(self.partial(self.program(21, program21, data), depth0), function (el) { element1 = el; });
  self.setAttribute(function () { return element1; }, self.partial(self.program(23, program23, data), depth0), self.partial(self.program(25, program25, data), depth0));
  appendChild(element1, self.program(27, program27, data)(depth0));
  appendChild(buffer, stack1);
  appendChild(buffer, document.createTextNode("\n    "));
  return buffer;
  }
...
function program27(depth0,data) {
  ...
  return document.createTextNode("show button");
  }

  stack1 = element1 = self.createElement(self.partial(self.program(1, program1, data), depth0), function (el) { element1 = el; });
  appendChild(element1, self.program(3, program3, data)(depth0));
  return stack1;
  });
},{"dombars/runtime":10}],2:[function(require,module,exports){
var dombars = require('dombars/runtime');
...
},{"./index.hbs":1,"dombars/runtime":10}],3:[function(require,module,exports){
...
},{"./utils":9,"handlebars/dist/cjs/handlebars/base":11}],4:[function(require,module,exports){
module.exports = require('handlebars/dist/cjs/handlebars/exception')['default'];

},{"handlebars/dist/cjs/handlebars/exception":12}],5:[function(require,module,exports){
(function (global){
/**
...
},{"./raf":5,"./utils":9,"handlebars/dist/cjs/handlebars/runtime":13}],7:[function(require,module,exports){
module.exports = require(
  'handlebars/dist/cjs/handlebars/safe-string'
)['default'];

},{"handlebars/dist/cjs/handlebars/safe-string":14}],8:[function(require,module,exports){
...
},{"./safe-string":7,"./track-node":8,"handlebars/dist/cjs/handlebars/utils":15}],10:[function(require,module,exports){
...
},{"./lib/base":3,"./lib/exception":4,"./lib/runtime":6,"./lib/safe-string":7,"./lib/utils":9}],11:[function(require,module,exports){
"use strict";
var Utils = require("./utils");
